...
void read_elf_header(unsigned char* base)
{
    ...
    Elf32_Half    e_type = Ehdr->e_type;                /* Object file type */
    Elf32_Half    e_machine = Ehdr->e_machine;          /* Architecture */
    Elf32_Word    e_version = Ehdr->e_version;          /* Object file version */
    Elf32_Addr    e_entry = Ehdr->e_entry;              /* Entry point virtual address */
    Elf32_Off     e_phoff = Ehdr->e_phoff;              /* Program header table file offset */
    Elf32_Off     e_shoff = Ehdr->e_shoff;              /* Section header table file offset */
    Elf32_Word    e_flags = Ehdr->e_flags;              /* Processor-specific flags */
    Elf32_Half    e_ehsize = Ehdr->e_ehsize;            /* ELF header size in bytes */
    Elf32_Half    e_phentsize = Ehdr->e_phentsize;      /* Program header table entry size */
    Elf32_Half    e_phnum = Ehdr->e_phnum;              /* Program header table entry count */
    Elf32_Half    e_shentsize = Ehdr->e_shentsize;      /* Section header table entry size */
    Elf32_Half    e_shnum = Ehdr->e_shnum;              /* Section header table entry count */
    Elf32_Half    e_shstrndx = Ehdr->e_shstrndx;        /* Section header string table index */
